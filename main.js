        ...
        new Ractive({
            ...
            oninit: function () {
                ...
                this.observe('year',function(year, oldyear, keypath) {
                    if(year != null && year > 1900 && year < 2017)
                        this.set({
                            'params': Object.assign(this.get('params'), {year: year, page: 1}),
                            'results': []
                        })
                            .then(function () {
                ...
                eventEmitter.on("SEARCH_QUERY_EVENT", function (params) {
                    ...
                    this.set({
                        ...
                        .then(function () {
                            this.search(Object.assign(this.get('params'),{page: 1}));
                            this.show('main')
                        }.bind(this));
            ...
            navPage: function(forward) {
                this.set('results', [])
                if(forward) {
                    this.search(Object.assign(this.get('params'), {page: this.get('pagination.page') + 1}))
                } else {
                    this.search(Object.assign(this.get('params'), {page: this.get('pagination.page') - 1}))
                }
            },
            ...
            selectGenre: function (genre) {
                this.set({
                    'params': Object.assign(this.get('params'), {genre: genre, page: 1}),
                    'results': []
                })
                    .then(function () {
                        this.search(this.get('params'))
            ...
            selectStyle: function (style) {
                this.set({
                    'params': Object.assign(this.get('params'), {style: style, page: 1}),
                    'results': []
                })
                    .then(function () {
                        this.search(this.get('params'))
            ...
            selectCountry: function (country) {
                this.set({
                    'params': Object.assign(this.get('params'), {country: country, page: 1}),
                    'results': []
                })
                    .then(function () {
                        this.search(this.get('params'))
